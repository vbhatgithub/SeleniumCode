...
public class ProductInfoPage {
	...
	private By productMetaData = By.xpath("//div[@id='content']//ul[1][@class='list-unstyled']/li");
	private By productPriceData = By.xpath("//div[@id='content']//ul[2][@class='list-unstyled']/li");
